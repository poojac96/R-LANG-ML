#R will always read the matrix values column wise from top to bottom.
# In a matrix if a column has more values than our defined column values, R will repeat the values from start
#IF a column has less number of values than the defined column, R will only use as many as variables are present in the column of a matrix 
